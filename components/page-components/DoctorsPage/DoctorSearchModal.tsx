...
const DoctorSearchModal: React.FC<DoctorSearchModalProps> = ({ isOpen, onClose }) => {
  const { fetchDoctors, searchDoctors, filteredDoctors, loading, error } = useDoctorStore();
            ...
            {filteredDoctors.map((doctor) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {doctor.specialty} | Rating: {doctor.rating}
                </p>
              </div>
            ))}
          </div>
