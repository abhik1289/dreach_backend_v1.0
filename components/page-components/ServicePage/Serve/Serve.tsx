...
export const ServiceData = [
	{
		id: 1,
		icon: <FaUserMd className="text-5xl text-[#31ADDB] group-hover:text-white transition-all duration-300 transform group-hover:scale-110" />,
		text: "Expert Consultation",
		desc: "Connect with top specialists through seamless video consultations available 24/7.",
	},
	{
		id: 2,
		icon: <FaHospital className="text-5xl text-[#31ADDB] group-hover:text-white transition-all duration-300 transform group-hover:scale-110" />,
		text: "Integrated Care",
		desc: "Comprehensive healthcare combining virtual consultations and local nursing support.",
	},
	{
		id: 3,
		icon: <FaVideo className="text-5xl text-[#31ADDB] group-hover:text-white transition-all duration-300 transform group-hover:scale-110" />,
		text: "Virtual Care",
		desc: "Quick and easy video consultations with pre-consultation symptom sharing.",
	},
	{
		id: 4,
		icon: <MdHomeWork className="text-5xl text-[#31ADDB] group-hover:text-white transition-all duration-300 transform group-hover:scale-110" />,
		text: "Home Healthcare",
		desc: "Professional healthcare services delivered right to your doorstep.",
	},
	{
		id: 5,
		icon: <MdBiotech className="text-5xl text-[#31ADDB] group-hover:text-white transition-all duration-300 transform group-hover:scale-110" />,
		text: "Diagnostics",
		desc: "Home sample collection with digital results and expert interpretation.",
	},
	{
		id: 6,
		icon: <RiMedicineBottleFill className="text-5xl text-[#31ADDB] group-hover:text-white transition-all duration-300 transform group-hover:scale-110" />,
		text: "Pharmacy",
