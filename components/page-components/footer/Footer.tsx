...
const Footer = () => {
	return (
		<>
			{/* for 1280px / 1440px */}
			<footer className="bg-[#061418] xl:block hidden pt-10 xl:px-10 2xlg:px-20">
								...
								<a>
									<div className="flex gap-4 items-center justify-start ">
										...
										<p className="text-[#31ADDB] text-4xl font-semibold italic hidden md:block">
											Dr. <span className="text-[#125872]">Reach</span>
										</p>
									</div>
								</a>
							</Link>
			...
			{/* for 1024px */}
			<footer className="bg-[#061418] lg:block hidden pt-10 xl:hidden px-10">
				<div className="flex justify-between px-28">
					<div>
						...
						<div className="mt-10 w-80">
							{contactInfo.map((info, index) => (
								<div className="flex my-3 items-center" key={index}>
									<info.icon className="text-slate-400 text-2xl mr-4" />
									<p className="text-slate-300">{info.text}</p>
								</div>
							))}
						</div>
					...
					<div className=" ">
						<h2 className="font-semibold pt-6 text-neutral-300 text-xl">
							Quick Links
						</h2>
						<div className="p-2 w-32 h-1 border-b-2  border-sky-300"></div>
