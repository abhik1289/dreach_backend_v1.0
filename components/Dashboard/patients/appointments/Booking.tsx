...
const bookingSchema = z.object({
	...
	reason: z.string().min(3, "Reason must be at least 3 characters long").max(100, "Reason must not exceed 100 characters"),
});
			...
			<Card className="shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-blue-50 to-purple-50">
				...
				<CardContent className="mt-6">
					<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
						<div>
							<Label htmlFor="provider" className="flex items-center text-lg font-semibold text-gray-700">
						...
						<div>
							<Label htmlFor="time" className="flex items-center text-lg font-semibold text-gray-700">
						...
						<div>
							<Label htmlFor="reason" className="flex items-center text-lg font-semibold text-gray-700">
