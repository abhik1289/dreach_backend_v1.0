...
const Summary: React.FC<SummaryProps> = ({ conditions, medications, allergies }) => {
  return (
    <Card className="w-full bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg overflow-hidden">
      <CardHeader className="bg-white bg-opacity-70 backdrop-blur-sm">
        <CardTitle className="text-2xl font-bold text-indigo-700">Medical Summary</CardTitle>
      </CardHeader>
      <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <h3 className="text-lg font-semibold text-indigo-600 mb-2">Medical Conditions</h3>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <h3 className="text-lg font-semibold text-indigo-600 mb-2">Current Medications</h3>
          <ScrollArea className="h-[200px] w-full rounded-md border p-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <h3 className="text-lg font-semibold text-indigo-600 mb-2">Allergies</h3>
          <ScrollArea className="h-[200px] w-full rounded-md border p-4">
