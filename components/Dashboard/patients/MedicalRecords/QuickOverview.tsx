...
const QuickOverview: React.FC<QuickOverviewProps> = ({ conditions, medications, allergies }) => {
  return (
...
const OverviewCard: React.FC<OverviewCardProps> = ({ title, icon, items, gradientFrom, gradientTo }) => (
