      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[ 
            ...
            { icon: MapPinIcon, text: "123 Health Street, Medical City, 12345" },
          ].map(({ icon: Icon, text }, index) => (
            <div key={index} className="flex items-center space-x-3 bg-white/20 p-4 rounded-lg backdrop-blur-sm transition-all duration-300 hover:bg-white/30 cursor-pointer">
