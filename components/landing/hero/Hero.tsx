...
const Hero: React.FC = () => {
	...
	const handleClick = async () => {
		...
		await delay(1000); // Replace with your actual logic
		setIsLoading(false);
	};
					...
					<div className="text-white w-full lg:w-1/2 mt-8 lg:mt-0">
						...
						<div className="flex justify-center lg:justify-start mb-8 sm:mb-12">
							{isButtonVisible && (
								<button
									type="button"
									className="bg-orange-500 text-base sm:text-lg hover:bg-white text-white hover:text-orange-500 font-bold py-2.5 sm:py-3 px-6 sm:px-8 rounded-full transition duration-300 shadow-lg hover:shadow-xl"
									title="Book Now"
									onClick={handleClick}>
						...
						<div className={`w-full md:w-[80%] lg:w-full mx-auto lg:mx-0`}>
							<div
								className={`bg-white bg-opacity-10 lg:bg-none lg:bg-opacity-0 rounded-lg p-4 sm:p-6 md:p-8`}>
								<div
