...
const services = [
  {
    ...
    description: 'Connect with multiple specialists in seamless video consultations'
  },
  {
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 relative">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-sky-200/80 max-w-2xl mx-auto">
            Experience healthcare that's accessible, convenient, and comprehensive
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-start space-x-3">
                <div className="p-2.5 rounded-lg bg-sky-50 dark:bg-sky-900/50 
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-sky-50 
